...
# ckp_path = '/home/zhuqiang/STDF30/exp/TGDA_7_SDCB2_QP37_MFQEv2/ckp_11000.pt'
ckp_path = '/home/zhuqiang/STDF30/exp/TGDA_7_QP37_1_MFQEv2/ckp_255000.pt'
...
# raw_yuv_path = './data/MFQEv2/test_18/raw/BasketballPass_416x240_500.yuv'
# lq_yuv_path = './data//MFQEv2/test_18/HM16.5_LDP/QP37/BasketballPass_416x240_500.yuv'
...
# raw_yuv_path = './data/MFQEv2/test_18/raw/BQMall_832x480_600.yuv'
# lq_yuv_path = './data//MFQEv2/test_18/HM16.5_LDP/QP37/BQMall_832x480_600.yuv'

# raw_yuv_path = './data/MFQEv2/test_18/raw/Cactus_1920x1080_500.yuv'  #  KristenAndSara_1280x720_600
# lq_yuv_path = './data//MFQEv2/test_18/HM16.5_LDP/QP37/Cactus_1920x1080_500.yuv'

# raw_yuv_path = './data/MFQEv2/test_18/raw/KristenAndSara_1280x720_600.yuv'  #  KristenAndSara_1280x720_600
# lq_yuv_path = './data//MFQEv2/test_18/HM16.5_LDP/QP37/KristenAndSara_1280x720_600.yuv'

# raw_yuv_path = './data/MFQEv2/test_18/raw/BlowingBubbles_416x240_500.yuv'  #  KristenAndSara_1280x720_600
# lq_yuv_path = './data//MFQEv2/test_18/HM16.5_LDP/QP37/BlowingBubbles_416x240_500.yuv'

# raw_yuv_path = './data/MFQEv2/test_18/raw/BlowingBubbles_416x240_500.yuv'  #  KristenAndSara_1280x720_600
# lq_yuv_path = '/home/zhuqiang/STDF30/realworld_yuv/Hiking.yuv'

raw_yuv_path = './data/MFQEv2/test_18/raw/FourPeople_1280x720_600.yuv'  #  KristenAndSara_1280x720_600
lq_yuv_path = './data//MFQEv2/test_18/HM16.5_LDP/QP37/FourPeople_1280x720_600.yuv'
...
def receive_arg():
    ...
    parser.add_argument(
        '--opt_path', type=str, default='./config/TGDA/option_TGDA_7_37.yml', 
...
def main():
    ...
    for idx in range(nfs):
        ...
        f.write(msg)
        # save it!
        # print("save_current",save_current)
        if save_current:
